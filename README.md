...
[![GitHub Stars](https://img.shields.io/github/stars/kundalik-dev/mdocks-support?label=Stars&style=for-the-badge&logo=github&logoColor=white)](https://github.com/kundalik-dev/mdocks-support/stargazers)
[![GitHub Issues](https://img.shields.io/github/issues/kundalik-dev/mdocks-support?label=Issues&style=for-the-badge&logo=github&logoColor=white)](https://github.com/kundalik-dev/mdocks-support/issues)
...
Found a bug with the viewer, file tree, or local server? Let us know!

**[Report Bug →](https://github.com/kundalik-dev/mdocks-support/issues/new?template=bug_report.yml)**
...
**[Ask a Question →](https://github.com/kundalik-dev/mdocks-support/issues/new?template=question.yml)** | **[Support & FAQ →](https://github.com/kundalik-dev/mdocks-support/wiki)** | **[Discussions →](https://github.com/kundalik-dev/mdocks-support/discussions)**
...
- **Search first** - Check if your issue or idea already exists in our active issues or discussions list.
- **Be specific** - Provide precise steps to reproduce, browser details, and screenshots where possible.
- **One issue per report** - Keep bug reports and feature requests focused on a single topic.
- **No sensitive data** - Ensure private repository URLs, tokens, or credentials are removed from logs and screenshots.
